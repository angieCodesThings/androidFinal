...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (price != null && price < 0) {
            throw new IllegalArgumentException("Product requires a breed");
        }
        ...
        String phone = values.getAsString(ProductContract.ProductEntry.COLUMN_PHONE);
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link ProductEntry#COLUMN_PHONE} key is present,
        // check that the weight value is valid.
        if (values.containsKey(ProductContract.ProductEntry.COLUMN_PHONE)) {
            // Check that the weight is greater than or equal to 0 kg
            String weight = values.getAsString(ProductContract.ProductEntry.COLUMN_PHONE);
            if (weight == null) {
